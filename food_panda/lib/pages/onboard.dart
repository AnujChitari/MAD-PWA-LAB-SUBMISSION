...
import 'package:food_panda/widget/content_model.dart';
          ...
          GestureDetector(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 37, 29, 28), borderRadius: BorderRadius.circular(20)),
              height: 60,
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                      color: Color.fromARGB(255, 26, 204, 115),
                      fontSize: 20.0,
